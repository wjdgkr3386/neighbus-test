...
@RestController
public class AdminMobilRestController {
    ...
    public AdminMobilRestController(InquiryService inquiryService, AdminService adminService, NoticeService noticeService, FreeboardService freeboardService, RecruitmentService recruitmentService, AdminMapper adminMapper) {

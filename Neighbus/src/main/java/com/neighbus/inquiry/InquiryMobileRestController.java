...
@RestController 
@RequestMapping("/api/mobile/inquiry") 
public class InquiryMobileRestController {

    private final InquiryService inquiryService;
 

    @Autowired 
    public InquiryMobileRestController(InquiryService inquiryService) {
        this.inquiryService = inquiryService;
    }

    @PostMapping("/register") // Path changed from /api/inquiry/register
    ...
    // 관리자용 API - 모든 문의 조회
    @GetMapping("/admin/list") // Path changed from /api/inquiry/admin/list
    ...
    // 관리자용 API - 문의 상세 조회
    @GetMapping("/admin/{id}") // Path changed from /api/inquiry/admin/{id}
    ...
    // 관리자용 API - 문의 상태 변경
    @PostMapping("/admin/update-state") // Path changed from /api/inquiry/admin/update-state
    ...
    // 관리자용 API - 문의 삭제
    @PostMapping("/admin/delete") // Path changed from /api/inquiry/admin/delete
    ...
    @PostMapping("/admin/add-comment") // Path changed from /api/inquiry/admin/add-comment
    ...
    // 사용자의 '나의 문의' 목록 조회
    @GetMapping("/my-inquiries") // Path changed from /api/inquiry/my-inquiries
